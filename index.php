...
<div id="pagewrap">
	...
	<header id="header">
		...
		<hgroup>
			<h1 id="site-logo"><a href="#">Carnicería Niku</a></h1>
			<!--h2 id="site-description">blablalblabla</h2-->
		</hgroup>
...
?>
	...
	<footer id="footer">
		...
		<!--img src="imagenes/mach_monkey.gif" alt="Mono" style="width:128px;height:128px;"-->
